...
export enum AuditAction {
  ...
  SHIPMENT_REQUEST_RESPONDED = "SHIPMENT_REQUEST_RESPONDED",
  SHIPMENT_REQUEST_COUNTERED = "SHIPMENT_REQUEST_COUNTERED",
  SHIPMENT_REQUEST_CONFIRMED = "SHIPMENT_REQUEST_CONFIRMED",
